...
//    static final String PASS = "123456";
    ...
    private static Map<String,List<RemarkInfo>> getCacheRemarkInfoMap() throws SQLException {
        ...
        String sql="select com_type,com_code,com_desc,parent_com_code,valid_status from sys_dict_code ";
        Statement stmt=conn.createStatement();
        ResultSet resultSet=stmt.executeQuery(sql);
        while (resultSet.next()){
            ...
            remarkInfos.add(new RemarkInfo(resultSet.getInt("com_code"),resultSet.getInt("parent_com_code"),resultSet.getString("com_desc"),resultSet.getString("valid_status")));
        }
